...
DROP TABLE IF EXISTS `addCollege`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `addCollege` (
  `id` int NOT NULL AUTO_INCREMENT,
  `collegeName` varchar(255) NOT NULL,
  `collegeCount` int NOT NULL,
  PRIMARY KEY (`id`),
...
LOCK TABLES `addCollege` WRITE;
/*!40000 ALTER TABLE `addCollege` DISABLE KEYS */;
/*!40000 ALTER TABLE `addCollege` ENABLE KEYS */;
UNLOCK TABLES;
